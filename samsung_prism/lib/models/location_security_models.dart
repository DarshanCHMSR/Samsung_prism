...
class UserLocation {
  ...
  /// Calculate distance from this location to another (alias for distanceTo)
...
class TrustedLocation {
  ...
  final bool isActive;
  final double radiusKm; // Radius in kilometers
  ...
  TrustedLocation({
    ...
    this.isActive = true,
    this.radiusKm = 0.5, // Default 500 meters
  });
  ...
  /// Check if a location is contained within this trusted location's radius
  bool containsLocation(UserLocation userLocation) {
    return isNear(userLocation, radiusKm: radiusKm);
  }
  ...
  factory TrustedLocation.fromJson(Map<String, dynamic> json) {
    return TrustedLocation.fromMap(json);
  }
}
...
class LoginAttempt {
  ...
  factory LoginAttempt.fromJson(Map<String, dynamic> json) {
    return LoginAttempt.fromMap(json);
  }
}
...
class SecurityAlert {
  ...
  factory SecurityAlert.fromJson(Map<String, dynamic> json) {
    return SecurityAlert.fromMap(json);
  }
